...
function ProductUI({ image, title, price, des, category, id }) {
  return (
    <div className=" p-4 border border-[#262626] flex flex-col mx-5 my-5 rounded-xl lg:flex-row lg:mx-10 lg:my-10 lg:justify-around">
      <img
        src={image}
        className="w-[288px] h-[288px] rounded-md m-auto lg:w-[382px] lg:h-[288px] ml-[100px] lg:ml-0  mr-10"
      />
      <div>
