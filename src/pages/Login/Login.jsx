      ...
      <form className="flex flex-col  justify-center items-center w-full">
        <div className="flex flex-col ">
          ...
          <input
            type="email"
            id="1"
            className="rounded-lg border w-[250px] md:w-[500px] py-3 text-black  border-[#262626] mb-5"
          />
        </div>
        <div className="flex flex-col">
          ...
          <input
            type="password"
            id="2"
            className="rounded-lg border w-[250px] md:w-[500px] py-3 text-black  border-[#262626] "
          />
        </div>
      </form>
      <div className="flex flex-col items-center mb-10 mt-5 justify-center gap-5 w-full">
        <button className="rounded-lg text-white py-4 w-[200px] md:w-[300px] border bg-[#703BF7] border-[#262626]">
          Login
        </button>
        <button
          className="rounded-lg py-4 w-[200px] md:w-[300px]  border border-[#262626] "
